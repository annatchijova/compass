...
// The API status values (latente/activa/…) are internal Spanish enum
// identifiers; the visible label is looked up via i18n ("status.<value>").
...
export function StatusChip({ status }: { status: HypothesisStatus }) {
  ...
  // Fall back to the raw enum value if an unexpected status arrives.
